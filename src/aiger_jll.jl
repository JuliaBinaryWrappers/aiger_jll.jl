...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import aiger_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("9446b0d0-acab-56e8-85a3-5890a8313c19"))
platforms = [Pkg.Artifacts.unpack_platform(e, "aiger", artifacts_toml) for e in artifacts["aiger"]]
...
if best_platform === nothing
    @debug("Unable to load aiger; unsupported platform $(triplet(platform_key_abi()))")
else
